...
class BaseClassifier:
    ...
    def fit(
        ...
        X_val=None,
        Y_val=None,
        val_metrics: Mapping[str, Metric] = None,
    ):
        # Create dataset
        ...
        print("Best model path:", self.trainer_wrappper.trainer.checkpoint_callback.best_model_path)
        self.module = self.module_class.load_from_checkpoint(
            self.trainer_wrappper.trainer.checkpoint_callback.best_model_path
        )
