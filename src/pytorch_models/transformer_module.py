...
class TransformerModule(BaseModule):
    def __init__(
        ...
        **kwargs,
        ...
        print(f"Initializing TransformerModule with model_name={model_name_or_path} ...")
        ...
        self.output = FullyConnectedOutput(self.config.hidden_size, output_size, layer_units=output_hidden_units, hidden_dropout=kwargs.get("hidden_dropout", 0), output_nonlin=nn.Sigmoid(), loss = loss)
    ...
    def dense_optimizer_parameters(self):
        return self._get_optimizer_grouped_parameters(layer_wise_lr=self.hparams.layer_wise_lr, layer_wise_lr_mutliplier=self.hparams.layer_wise_lr_mutliplier)

    def _get_optimizer_grouped_parameters(self, layer_wise_lr=False, layer_wise_lr_mutliplier=1.1):
