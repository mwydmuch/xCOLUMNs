...
def _predicted_positives(y_pred: Union[np.ndarray, csr_matrix], axis: int=None, epsilon: float=0.01):
    """
...
def _positives(y_true: Union[np.ndarray, csr_matrix], axis: int=None, epsilon: float=0.01):
    """
...
def precision(*, y_true: Union[np.ndarray, csr_matrix], y_pred: Union[np.ndarray, csr_matrix], axis: int, epsilon: float=0.01):
    """
...
def recall(*, y_true: Union[np.ndarray, csr_matrix], y_pred: Union[np.ndarray, csr_matrix], axis: int, epsilon: float=0.01):
    """
...
def fmeasure(*, y_true: Union[np.ndarray, csr_matrix], y_pred: Union[np.ndarray, csr_matrix], axis: int, beta: float=1, epsilon: float=0.01):
    """
