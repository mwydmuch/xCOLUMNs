...
def _predict_weighted_per_instance_np_fast(
    y_proba: np.ndarray,
    k: int,
...
def _predict_weighted_per_instance_csr(
    ...
    n, m = y_proba.shape
    y_pred_data, y_pred_indices, y_pred_indptr = numba_predict_weighted_per_instance_csr(
...
def predict_weighted_per_instance(
    ...
    if isinstance(y_proba, np.ndarray):
        y_pred = _predict_weighted_per_instance_np(y_proba, k, th=th, a=a, b=b)
    elif isinstance(y_proba, csr_matrix):
        y_pred = _predict_weighted_per_instance_csr(y_proba, k, th=th, a=a, b=b)
